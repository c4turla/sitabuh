<div class="main-content">
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Data Kapal Rusak</div>
      </div>
    </div>

    <div class="section-body">
      <h2 class="section-title">Data Kapal Rusak</h2>
      <p class="section-lead"> List Data Kapal Rusak (Floating Repair)</p>
      <div class="card">
            ...
            <table class="table table-striped" id="table-1">
              ...
              <?php
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-warning btn-sm" href="<?= base_url('tambatlabuh/cetak_fr/'); ?><?php echo $row['id_tambat']; ?>" target="_blank"> <span class='fa fa-print fa-xs'></span></a>
                        <div class='btn-group mb-2'>
                          ...
                          <div class='dropdown-menu'>
                            ...
                            <a class='dropdown-item' href='<?= base_url('tambatlabuh/hapus_kr/'); ?><?php echo $row['id_tambat']; ?>' class="badge badge-danger pl-2 pr-2" onclick="return confirm('Apakah kamu ingin menghapus data ini?');">Hapus Data</a>
                          </div>
                        </div>
                      </td>
                    </tr>
  ...
  <div class='modal fade' id='tambah-data' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true' style='display: none;'>
    <div class='modal-dialog modal-lg'>
      <div class='modal-content'>
        ...
        <form id="form1" action="<?php echo base_url('tambatlabuh/tambahkapalrusak')?>" method="post">
  ...
  <div class='modal fade' id='edit-data<?php echo $row['id_tambat']; ?>' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true' style='display: none;'>
    <div class='modal-dialog modal-lg'>
      <div class='modal-content'>
        <div class="modal-header">
          <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Void Data Kapal Rusak</h6>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="form1" action="<?php echo base_url('tambatlabuh/voidkapalrusak')?>" method="post">
          <div class='modal-body'>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="namakapal" class="col-form-label">Nama Kapal</label>
